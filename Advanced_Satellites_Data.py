...
# Assuming you have a CSV file named 'UCS-Satellite-Database-5-1-2022 - Sheet1.csv' with columns 'Date of Launch' and 'Type'
# Load the dataset
...
satellite_counts = df.groupby(['Date of Launch', 'Type']).size().unstack(fill_value=0)
